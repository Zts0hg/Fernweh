        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            <?php
              ...
              $currentMonth = date('m');
              //
              $query3 = "SELECT * FROM article where (author='$username') AND (subtime LIKE '$currentYear%') AND ($currentMonth - MONTH(subtime) <= 3) ORDER BY subtime desc";
              $result = $db->query($query3);
              if ($result){
