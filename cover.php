...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="images/fernwehicon.png" title="GitHub" type="image/x-icon" >
  </head>
  <body>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  <a class="navbar-brand" href="index.php">Fernweh-Blog</a>
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="registration/sign-up.php" tabindex="-1" aria-disabled="true">Register</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php" tabindex="-1" aria-disabled="true">VisitNow</a>
      </li>
    </ul>
  </div>
    </nav>
